...
torch::Tensor _expert_exchange(
        ...
        long n_expert, torch::Tensor new_experts_to_devices, long max_len, torch::Tensor reorder_local_expert_count,
        torch::Tensor global_expert_count_zeros, long n_workers);
